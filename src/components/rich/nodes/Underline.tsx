...
const Underlineded = ({  }: IProps) => {
    const holeRef = useRef<HTMLParagraphElement>(null);
    return <p ref={holeRef} style={{ textDecoration: 'underline' }}></p>;
};
...
class Underlined extends React.Component<{}, {}> {
    ...
    render() {
        ...
        return <p ref={this.hole} style={{ textDecoration: 'underline' }} />;
    }
}
...
export class Underline implements NodeView {
    ...
    constructor(
        ...
        ReactDOM.render(<Underlined ref={this.ref} />, this.dom, this.putContentDomInRef);
    }
